      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md text-center">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div className="relative">
            <Lock className="absolute top-3 right-3 text-gray-400 w-5 h-5" />
            <input
              type="password"
              placeholder="סיסמת מנהל"
              className="w-full p-3 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lev-blue outline-none"
              value={password}
